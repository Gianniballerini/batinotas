...
class TemporalTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temporal_task" do
    assert_difference('TemporalTask.count') do
      post temporal_tasks_url, params: { temporal_task: { description: @temporal_task.description, priority: @temporal_task.priority, state: @temporal_task.state, valid_from: @temporal_task.valid_from, valid_until: @temporal_task.valid_until } }
    end
  ...
  test "should update temporal_task" do
    patch temporal_task_url(@temporal_task), params: { temporal_task: { description: @temporal_task.description, priority: @temporal_task.priority, state: @temporal_task.state, valid_from: @temporal_task.valid_from, valid_until: @temporal_task.valid_until } }
