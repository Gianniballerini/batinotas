...
class SimpleTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create simple_task" do
    assert_difference('SimpleTask.count') do
      post simple_tasks_url, params: { simple_task: { description: @simple_task.description, priority: @simple_task.priority, state: @simple_task.state } }
    end
  ...
  test "should update simple_task" do
    patch simple_task_url(@simple_task), params: { simple_task: { description: @simple_task.description, priority: @simple_task.priority, state: @simple_task.state } }
